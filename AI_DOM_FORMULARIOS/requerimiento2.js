...
function validacion() {
    ...
    //ningún radio button, se arrojará un "evento alert" donde se indique el error.
   ...
   if (tamano.length === 0) {
    ...
    //checkbox, se arrojará un "evento alert" donde se indique el error.
   quesos = document.getElementsByName("quesos");
